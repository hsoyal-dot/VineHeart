...
val SUPABASE_API_KEY = gradleLocalProperties(rootDir, providers).getProperty("SUPABASE_API_KEY", "")

android {
    namespace = "com.example.wearos_heartrate"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.wearos_heartrate"
        minSdk = 33
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
